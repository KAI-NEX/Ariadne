...
const conversationDescriptor = {
  ...
  runtime_capability_basis: "adapter_verified", adapter_version: "deepseek-candidate-conversation-v7",
  runtime_capabilities: {
...
const conversationSnapshot = Runtime.createRuntimeSnapshot(
  { mode: "model", provider: "deepseek", model: "deepseek-v4-pro" },
  {
    ...
    requestConfigVersion: "deepseek-candidate-conversation-request-v8",
  },
);
