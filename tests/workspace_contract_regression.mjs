...
for (const script of [demoDomain, localFirst, localJobs, careerEvidence, careerProfile]) assert.match(script, /DB_VERSION = 16/);
...
console.log(JSON.stringify({
  ...
  indexeddb_version_path: "unified_v16_additive_personal_understanding_stores_pass",
}, null, 2));
