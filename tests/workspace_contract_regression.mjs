...
for (const script of [demoDomain, localFirst, localJobs, careerEvidence, careerProfile]) assert.match(script, /DB_VERSION = 17/);
...
console.log(JSON.stringify({
  ...
  indexeddb_version_path: "unified_v17_additive_job_overview_stores_pass",
}, null, 2));
