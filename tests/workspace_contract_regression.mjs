...
for (const script of [demoDomain, localFirst, localJobs, careerEvidence, careerProfile]) assert.match(script, /DB_VERSION = 13/);
...
console.log(JSON.stringify({
  ...
  indexeddb_version_path: "unified_v13_additive_truth_stores_pass",
}, null, 2));
