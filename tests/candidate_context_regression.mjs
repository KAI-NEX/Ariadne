...
const proposal = { candidate_proposal_id: "proposal-1", source_document_id: "source-1", processing_run_id: "run-1", provider: "deepseek", model: "deepseek-flash", prompt_version: "candidate-proposal-v1", items: [item] };
...
let run = Domain.createProcessingRun({ run_id: "run-1", purpose: "CANDIDATE_IMPORT", source_ids: ["source-1"], provider: "deepseek", model: "deepseek-flash", prompt_version: "candidate-proposal-v1", delivery_method: "rendered_pdf_pages" }, now);
