...
assert.match(html, /runtime-capabilities\.js\?v=runtime-routing-v1/);
assert.match(html, /runtime-capability-gate\.js\?v=runtime-routing-v1/);
assert.match(html, /runtime-selection\.js\?v=runtime-routing-v1/);
...
assert.match(script, /recordOperationRuntimeSelection\(selected\)/);
assert.match(script, /function seedConfiguredConversationRuntime/);
assert.match(script, /model_id === "deepseek-v4-pro"/);
assert.match(script, /\{ only_unassigned: true \}/);
...
assert.match(loadModelsSource, /seedConfiguredConversationRuntime\(\)/);
