...
assert.doesNotMatch(script, /function seedConfiguredConversationRuntime/);
assert.match(script, /isModelRuntimeEligible/);
...
assert.doesNotMatch(loadModelsSource, /seedConfiguredConversationRuntime\(\)/);
