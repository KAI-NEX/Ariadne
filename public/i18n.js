...
(function attachAriadneI18n(root) {
  ...
  const RULES = Object.freeze([
    ...
    ,[/^本轮已发送：(.*)。原件已保存在此工作区；再次查看请重新添加，不自动纳入确认资料。$/su, (_, files) => `Sent in this turn: ${files}. Source files are saved in this workspace; add them again to view them later. They are not automatically added to confirmed information.`]
