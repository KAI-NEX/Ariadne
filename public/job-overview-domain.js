...
(function attach(root, factory) {
  ...
  async function callRuntime(request) {
    ...
    return transport.execute({ request, domain: "JOB_OVERVIEW", endpoint: "/api/job-overview-turn",
      fallback_error: "JOB_OVERVIEW_FAILED" });
  }
